        ...
        <section className="w-full bg-white mb-16">
          <div className="max-w-[1280px] mx-auto px-4 md:px-8 py-12">
            <div className="flex flex-col md:flex-row items-start gap-10">
              {/* Hero content is left-oriented: heading, description and button
                  all align to the left edge. */}
              <div className="flex flex-col items-start text-left gap-8 max-w-[672px] w-full">
